...
plt.show()
# print(np.random.dirichlet((1, 1, 1, 1, 1, 1), 1))
# print(np.random.dirichlet((10, 10, 10, 10, 10, 10), 1))
# print(np.random.dirichlet((100, 100, 100, 100, 100, 100), 1))
# print(np.random.dirichlet((1000, 1000, 1000, 1000, 1000, 1000), 1))
# print(np.random.dirichlet((10000, 10000, 10000, 10000, 10000, 10000), 1))
# print(np.random.dirichlet((1000000, 1000000, 1000000, 1000000, 1000000, 1000000), 1))